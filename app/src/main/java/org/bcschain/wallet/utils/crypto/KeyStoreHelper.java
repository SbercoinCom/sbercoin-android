package org.sbercoin.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    public final static String BCS_PIN_ALIAS = "bcs_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = BCSSharedPreference.getInstance().getSeed(context);
