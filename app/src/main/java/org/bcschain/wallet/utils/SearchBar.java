...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.sbercoin.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.sbercoin.wallet.R.id.text);
        input = (EditText) findViewById(org.sbercoin.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.sbercoin.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.sbercoin.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.sbercoin.wallet.R.id.bt_clear_search);
