...
public class AddressesListFragmentTokenDark extends AddressesListFragmentToken {
    ...
    protected void showTransferDialogFragment(final AddressWithTokenBalance keyWithBalanceTo, List<AddressWithTokenBalance> keyWithBalanceList, final int decimalUnits) {
        ...
        final TextInputEditText mEditTextAmount = (TextInputEditText) view.findViewById(org.sbercoin.wallet.R.id.et_amount);
        final Spinner spinner = (Spinner) view.findViewById(org.sbercoin.wallet.R.id.spinner_transfer);
        FontTextView mEditTextAddressTo = (FontTextView) view.findViewById(org.sbercoin.wallet.R.id.tv_address_to);
