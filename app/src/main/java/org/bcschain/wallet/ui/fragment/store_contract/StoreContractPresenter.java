...
import org.sbercoin.wallet.model.gson.qstore.QstoreBuyResponse;
...
import org.sbercoin.wallet.ui.fragment.send_fragment.SendInteractorImpl;
        ...
        getUnspentOutputs(new SendInteractorImpl.GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(getView().getContext().getString(R.string.invalid_bcs_address));
                    return;
                }
                //TODO STUB!
