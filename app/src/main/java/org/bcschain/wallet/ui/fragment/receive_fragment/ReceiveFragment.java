...
import org.sbercoin.wallet.ui.activity.main_activity.FragmentKeyboardEventListener;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView, FragmentKeyboardEventListener {
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "SBER QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "SBER QR-Code"));
        }
    }
