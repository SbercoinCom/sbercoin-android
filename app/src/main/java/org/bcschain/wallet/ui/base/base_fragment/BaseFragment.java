...
public abstract class BaseFragment extends Fragment implements BaseFragmentView {
    ...
    public void setAlertDialog(String title, String message, String buttonText, PopUpType type, final AlertDialogCallBack callBack) {
        try {
            ...
            FontTextView tvTitle = ((FontTextView) view.findViewById(org.sbercoin.wallet.R.id.tv_pop_up_title));
            tvTitle.setText(title);
            FontTextView tvMessage = ((FontTextView) view.findViewById(org.sbercoin.wallet.R.id.tv_pop_up_message));
            tvMessage.setText(message);
            FontButton popUpButton = ((FontButton) view.findViewById(org.sbercoin.wallet.R.id.bt_pop_up));
            view.findViewById(org.sbercoin.wallet.R.id.bt_pop_up2).setVisibility(View.GONE);

            ImageView icon = ((ImageView) view.findViewById(org.sbercoin.wallet.R.id.iv_icon));
            ...
            if (ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK)) {
                switch (type.name()) {
                    case "error":
                        ...
                        break;
                    case "confirm":
                        icon.setImageResource(org.sbercoin.wallet.R.drawable.ic_confirm);
                ...
                switch (type.name()) {
                    case "error":
                        ...
                        break;
                    case "confirm":
                        icon.setImageResource(org.sbercoin.wallet.R.drawable.ic_confirmed_light);
                        break;
                }
            }
    ...
    public void setAlertDialog(String title, String message, String buttonText, String buttonText2, PopUpType type, final AlertDialogCallBack callBack) {
        try {
            ...
            tvMessage.setText(message);
            FontButton popUpButton = ((FontButton) view.findViewById(org.sbercoin.wallet.R.id.bt_pop_up));
            FontButton popUpButton2 = ((FontButton) view.findViewById(org.sbercoin.wallet.R.id.bt_pop_up2));
            view.findViewById(org.sbercoin.wallet.R.id.bt_pop_up2).setVisibility(View.VISIBLE);
    ...
    public void openRootFragment(Fragment fragment) {
        ...
        getFragmentManager()
                .beginTransaction()
                .replace(org.sbercoin.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
    ...
    public void openFragment(Fragment fragment) {
        if(getFragmentManager().findFragmentByTag(fragment.getClass().getCanonicalName())==null) {
            ...
            getFragmentManager()
                    .beginTransaction()
                    .setCustomAnimations(org.sbercoin.wallet.R.anim.enter_from_right, org.sbercoin.wallet.R.anim.exit_to_left, org.sbercoin.wallet.R.anim.enter_from_left, org.sbercoin.wallet.R.anim.exit_to_right)
                    .add(org.sbercoin.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
                    .addToBackStack(null)
                    .commit();
        }
    }
