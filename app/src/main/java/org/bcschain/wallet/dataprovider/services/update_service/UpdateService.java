package org.sbercoin.wallet.dataprovider.services.update_service;
...
import org.sbercoin.wallet.utils.BCSIntent;
...
import static org.sbercoin.wallet.WearListCallListenerService.ADDRESS;
import static org.sbercoin.wallet.WearListCallListenerService.BALANCE;
import static org.sbercoin.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.sbercoin.wallet.WearListCallListenerService.ITEMS;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final BCSSharedPreference bcsSharedPreference = BCSSharedPreference.getInstance();

        String balanceString = bcsSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = bcsSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = bcsSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        bcsSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        bcsSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        bcsSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        BCSService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)
    ...
    private void sendNotification(String Ticker, String Title, String Text, Uri sound) {
        ...
        notificationIntent.setAction(BCSIntent.OPEN_FROM_NOTIFICATION);
