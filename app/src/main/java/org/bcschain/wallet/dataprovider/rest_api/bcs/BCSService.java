package org.sbercoin.wallet.dataprovider.rest_api.bcs;
...
public class BCSService {
    ...
    private static BCSService sBCSService;
    private BCSRestService mServiceApi;

    public static BCSService newInstance() {
        if (sBCSService == null) {
            sBCSService = new BCSService();
        }
        return sBCSService;
    }
    ...
    private BCSService() {
        try {
            ...
            mServiceApi = retrofit.create(BCSRestService.class);
