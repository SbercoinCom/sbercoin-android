...
import static org.sbercoin.wallet.SBERApplication.REALM_NAME;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final String address = SBERSharedPreference.getInstance().getCurrentAddress(WearListCallListenerService.this);
                    Gson gson = new Gson();
