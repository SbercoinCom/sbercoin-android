package org.sbercoin.wallet.ui.fragment.sbercoin_cash_management_fragment.light;
...
import org.sbercoin.wallet.ui.fragment.sbercoin_cash_management_fragment.AddressesWithBalanceAdapter;
import org.sbercoin.wallet.ui.fragment.sbercoin_cash_management_fragment.AddressesWithBalanceSpinnerAdapter;
    ...
    protected void showTransferDialogFragment(final AddressWithBalance keyWithBalanceTo, List<AddressWithBalance> keyWithBalanceList) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                tvBalanceFrom.setText(String.format("%s SBER", balance.toString()));
            }
