...
import org.sbercoin.wallet.ui.fragment.qr_code_recognition_fragment.QrCodeRecognitionFragment;
...
import org.sbercoin.wallet.utils.CustomContextWrapper;
...
import static org.sbercoin.wallet.ui.base.base_fragment.BaseFragment.BACK_STACK_ROOT_TAG;
...
public class MainActivity extends BaseActivity implements MainActivityView
{
    ...
    protected void onNewIntent(Intent intent)
    {
        ...
        if (intent != null && intent.getAction() != null)
        {
            ...
            {
                case SBERIntent.OPEN_FROM_NOTIFICATION:
                    openRootWallet();
                    break;
                default:
                    break;
    ...
    public boolean checkTouchIdEnable()
    {
        ...
        {
            if (SBERSharedPreference.getInstance().isTouchIdEnable(getContext()))
            {
    ...
    public void initializeViews()
    {
        ...
        switch (intent.getAction())
        {
            case SBERIntent.SEND_FROM_SDK:
                getPresenter().setSendFromIntent(true);
                mAddressForSendAction = intent.getStringExtra(SBERIntent.SEND_ADDRESS);
                mAmountForSendAction = intent.getStringExtra(SBERIntent.SEND_AMOUNT);
                mTokenAddressForSendAction = intent.getStringExtra(SBERIntent.SEND_TOKEN);
                break;
        ...
        { //Update wallet balance change listener
            @Override
    ...
    private void initBottomNavViewWithFont(int fontId)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < menuView.getChildCount(); i++)
            {
                ...
                TextView mSmallLabel = item.findViewById(android.support.design.R.id.smallLabel);
                TextView mLargeLabel = item.findViewById(android.support.design.R.id.largeLabel);
    ...
    {
        super.attachBaseContext(CustomContextWrapper.wrap(newBase, SBERSettingSharedPreference.getInstance().getLanguage(newBase)));
    }

    public SBERApplication getSBERApplication()
    {
        return (SBERApplication) getApplication();
    }
    ...
    public boolean checkSendQrCodeActive()
    {
        ...
        } else
        {
            ...
            {
                return fragmentByTag.getChildFragmentManager().findFragmentByTag(QrCodeRecognitionFragment.class.getCanonicalName()) != null;
            }
        }
        return false;
    }
    ...
    protected void updateTheme()
    {
        ...
        if (ThemeUtils.getCurrentTheme(this).equals(ThemeUtils.THEME_DARK))
        {
            ...
            mBottomNavigationView.setItemTextColor(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.grey)));
            mBottomNavigationView.setItemIconTintList(ColorStateList.valueOf(ContextCompat.getColor(this, R.color.grey)));
    ...
    {
        return ((SBERApplication) getApplication()).getRealm();
    }
