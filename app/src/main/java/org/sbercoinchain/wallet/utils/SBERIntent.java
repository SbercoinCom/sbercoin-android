...
public class SBERIntent
{
    ...
    public static final String SEND_AMOUNT = "sbercoin.intent.extra.SEND_AMOUNT";
    public static final String SEND_TOKEN = "sbercoin.intent.extra.SEND_TOKEN";
    public static final String USER_START_APP = "sbercoin.intent.extra.USER_START_APP";
    public static final String CHANGE_THEME = "sbercoin.intent.action.CHANGE_THEME";
}
